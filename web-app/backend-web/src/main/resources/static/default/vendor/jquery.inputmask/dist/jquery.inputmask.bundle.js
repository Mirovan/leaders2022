        ...
        numeric: {
            ...
            signHandler: function(chrs, maskset, pos, strict, opts) {
                if (!strict && opts.allowMinus && "-" === chrs || opts.allowPlus && "+" === chrs) {
                    ...
                    if (matchRslt && matchRslt[0].length > 0) return maskset.buffer[matchRslt.list] === ("-" === chrs ? "+" : opts.negationSymbol.front) ? "-" === chrs ? "" !== opts.negationSymbol.back ? {
                        pos: matchRslt.list,
                        c: opts.negationSymbol.front,
                        remove: matchRslt.list,
                        caret: pos,
                        insert: {
                        ...
                        pos: matchRslt.list,
                        c: "+",
                        remove: [ matchRslt.list, maskset.buffer.length - opts.suffix.length - 1 ],
                        caret: pos
                    } : {
                        pos: matchRslt.list,
                        c: "+",
                        remove: matchRslt.list,
                        caret: pos
                    } : maskset.buffer[matchRslt.list] === ("-" === chrs ? opts.negationSymbol.front : "+") ? "-" === chrs && "" !== opts.negationSymbol.back ? {
                        remove: [ matchRslt.list, maskset.buffer.length - opts.suffix.length - 1 ],
                        caret: pos - 1
                    } : {
                        remove: matchRslt.list,
            ...
            radixHandler: function(chrs, maskset, pos, strict, opts) {
                if (!strict && opts.numericInput !== !0 && chrs === opts.radixPoint && void 0 !== opts.digits && (isNaN(opts.digits) || parseInt(opts.digits) > 0)) {
                    ...
                    if (-1 !== radixPos && maskset.validPositions[radixPos]) return maskset.validPositions[radixPos - 1] ? {
                        ...
                        pos: integerValue.list,
                        c: integerValue[0],
                        caret: radixPos + 1
                    };
                    if (!integerValue || "0" === integerValue[0] && integerValue.list + 1 !== pos) return maskset.buffer[integerValue ? integerValue.list : pos] = "0",
                    {
                        pos: (integerValue ? integerValue.list : pos) + 1,
                        c: opts.radixPoint
                    };
                }
                return !1;
            ...
            leadingZeroHandler: function(chrs, maskset, pos, strict, opts, isSelection) {
                if (!strict) if (opts.numericInput === !0) {
                    ...
                    if (matchRslt && (-1 === radixPosition || radixPosition >= pos)) {
                        ...
                        if (0 === matchRslt[0].indexOf("" !== opts.placeholder ? opts.placeholder.charAt(0) : "0") && (matchRslt.list + 1 === pos || isSelection !== !0 && 0 === decimalPart)) return maskset.buffer.splice(matchRslt.list, 1),
                        {
                            pos: matchRslt.list,
                            remove: matchRslt.list
                        };
                        if ("0" === chrs && pos <= matchRslt.list && matchRslt[0] !== opts.groupSeparator) return !1;
                    }
                }
                return !0;
            },
